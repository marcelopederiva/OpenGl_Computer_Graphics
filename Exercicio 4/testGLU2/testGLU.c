...
//    	GLfloat mRotateZ[16];
    	...
    	// Set Translation
    	matrixTranslate4x4(-0.5f,0.0f,0.0f,mTransl);
    	//Set Rotation
//    	matrixRotate4x4(45,0.0f,0.0f,1.0f,mRotate);
//
//    	matrixRotate4x4(angle2,1.0f,0.0f,0.0f,mRotateX);
//    	matrixRotate4x4(angle,0.0f,0.0f,1.0f,mRotateZ);
//    	matrixRotate4x4(angle*4,0.0f,1.0f,0.0f,mRotateY);
//
//		// Set Model transformation
//    	// --------------------------------------
...
//
//    	matrixMultiply4x4(mRotateY, mXForm2, mXForm3);
//    	matrixMultiply4x4(mRotateZ, mXForm3, mXForm4);
//    	matrixMultiply4x4(mRotateX, mXForm4, mXForm5);
//
//		// Set ModelView Transformation
//		// --------------------------------------
//		matrixMultiply4x4(viewMatrix, mXForm5, modelViewMatrix);


		//QUATERNION

    	GLfloat mXForm3[16],mXForm4[16],mXForm5[16];
    	GLfloat Q_RotX[4];
    	GLfloat Q_RotY[4];
    	GLfloat Q_RotZ[4];
    	GLfloat Q_final[4];

    	quaternionRotationZ(45,mRotate);
    	quaternionRotationX(angle2,Q_RotX);
    	quaternionRotationZ(angle,Q_RotZ);
    	quaternionRotationY(angle*4,Q_RotY);

    	quaternionMultiply(Q_RotY,mRotate,mXForm3);
    	quaternionMultiply(Q_RotZ,mXForm3,mXForm4);
    	quaternionMultiply(Q_RotX,mXForm4,Q_final);
    	quaternion2Matrix4x4(Q_final, mXForm5);
